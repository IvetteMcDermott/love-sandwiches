...
def get_sales_data():
    """
    Get sales fiures input from the user
    """
    while True:
        print("Please enter sales data from the last market")
        print("Data should be siz numbers, separeted by commas")
...
def validate_data(values):
    ...
    or id there aren't exactly 6 values
    """
    try:
...
print("Welcome to Loe Sandwiches Data Automation")
main()